...
import SlideRow from "./components/feedback/SlideRow";
import SlideModal from "./components/feedback/SlideModal";
	...
	return (
		...
		>
			...
			{!feedbackData ? (
				...
				>
					No feedback available. Please complete a VC conversation and generate
					feedback first.
				</div>
				...
				<div>
					...
					>
						...
						<div style={{ fontSize: "14px", color: "#1976d2" }}>
							...
							{feedbackData.metadata.has_audio
								? " 🎙️ Audio processed"
								: " ⚠️ No audio"}{" "}
							•
							{feedbackData.metadata.has_conversation
								? " 💬 Q&A included"
								: " No Q&A"}
						</div>
					</div>
